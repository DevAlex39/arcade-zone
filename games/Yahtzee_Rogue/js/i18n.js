...
const I18N = {
  fr: {
    ...
    encyclopedia: 'Encyclopédie', fogOverlay: 'La Brume — 2 dés relancés sont voilés jusqu\'à la soumission',
    ...
    jokerConsumed: '🔥 {name} s\'est consumé !', handsLeftBadge: '{n} main(s)',
  ...
  en: {
    ...
    encyclopedia: 'Encyclopedia', fogOverlay: 'The Mist — 2 rerolled dice are veiled until you submit',
    ...
    jokerConsumed: '🔥 {name} burned out!', handsLeftBadge: '{n} hand(s)',
