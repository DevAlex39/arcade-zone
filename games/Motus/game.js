...
// Mots sans accents uniquement — le clavier du jeu ne propose que A-Z
const FALLBACK_WORDS = [...new Set([
  'MAISON','JARDIN','SOLEIL','MARCHE','FLEUVE','PIERRE','PRISON','FUSEAU',
  'BATEAU','CHEMIN','FORETS','MOUTON','LUMIERE','PAPIER','PLANTE','VENTRE',
  ...
  'LAPINS','MIROIR','NATION','PARLER','RIDEAU','SAUMON','TALENT',
  'VOISIN','WAGONS','ZEBRES','ARBRES','BALLON','DANSES',
  'ABRUPT','BRISER','CALMER','DANSER','ELEVER','FERMER','GARDER','HUMEUR',
  'IMPOSER','JOYEUX','KLAXON','LECONS','MOURIR','NAITRE','OUVRIR','PASSER',
  'QUARTZ','RANGER','SAUTER','TENTER','URGENT','VALEUR',
  'ACTION','BILLET','CARNET','DEBOUT','EFFORT','FACILE','GALERE','HASARD',
  'INDIEN','JUNGLE','LANCER','MARRON','NAVIRE','OPAQUE','PARTIR',
  'RAPIDE','SOLIDE','TOUCHE','ULTIME','VAGUES','YAOURT',
  'ACCENT','BEURRE','CIGARE','DONNER','EMPIRE','FONDER','GLOIRE','HUMAIN',
  'IRONIE','JOUEUR','LARGUE','METTRE','NOMMER','OCCUPER','PLAIRE',
  'QUICHE','RESTER','SORTIR','TISSER','UTOPIE','VIANDE','ZAPPER','ACTIVE',
  'BOUGER','CLAIRE','DESTIN','ENTIER','FIGURE','GRAINS','HANTER',
  'ISOLER','JAMBON','MATURE','NIVEAU','OREILLE','PLUTOT','REGARD',
  'SAVEUR','TERRES','UNIQUE','VIOLET','EXPRES',
