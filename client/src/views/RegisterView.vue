<template>
  <div class="auth-page">
    <div class="auth-card card">
      ...
      <p class="text-muted mb-2">C'est gratuit et rapide !</p>

      <form @submit.prevent="submit" class="auth-form">
        <div class="auth-row">
          <div class="input-group">
            <label>Prénom</label>
            <input v-model="form.first_name" type="text" placeholder="Alexis" />
          </div>
          <div class="input-group">
            <label>Nom</label>
            <input v-model="form.last_name" type="text" placeholder="Paillot" />
          </div>
        </div>
        <div class="input-group">
          <label>Nom d'utilisateur *</label>
          <input v-model="form.username" type="text" placeholder="alexis39" required />
        </div>
        <div class="input-group">
          <label>Email *</label>
          <input v-model="form.email" type="email" placeholder="alexis@mail.com" required />
        </div>
        <div class="input-group">
          <label>Mot de passe * (6 chars min)</label>
...
const form    = ref({ username: '', email: '', password: '', first_name: '', last_name: '' });
const error   = ref('');
